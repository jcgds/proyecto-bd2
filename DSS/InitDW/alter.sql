    ...
    constraint fk_continente_DWMpais foreign key (id_continente) references DW_continente (id)
);
...
alter table DW_metricas_concurso add (
    ...
    constraint fk_continente_DWMconcurso foreign key (id_continente) references DW_continente (id)
);
