...
alter table I_bodega add (
    constraint fk_bodega_tiempoAux foreign key (id_tiempoAux) references I_tiempoAux (id)
);

alter table I_marca add (
    constraint fk_marca_tiempoAux foreign key (id_tiempoAux) references I_tiempoAux (id)
);

alter table I_catador add (
    constraint fk_catador_tiempoAux foreign key (id_tiempoAux) references I_tiempoAux (id)
);

alter table I_concurso add (
    constraint fk_concurso_tiempoAux foreign key (id_tiempoAux) references I_tiempoAux (id)
);
