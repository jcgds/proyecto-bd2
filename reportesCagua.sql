...
--   Application:     101
--   Name:            WINES
--   Date and Time:   22:39 Sunday December 16, 2018
--   Exported By:     ANGEL
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4778317853291989));
...
wwv_flow_api.create_flow(
  ...
  p_checksum_salt_last_reset => '20181216222315',
  ...
  p_last_upd_yyyymmddhh24miss=> '20181216222315',
...
--application/shared_components/navigation/tabs/standard/t_inscripción
wwv_flow_api.create_tab (
  p_id=> 4916615805613704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Reportes',
  p_tab_sequence=> 20,
  p_tab_name=> 'T_INSCRIPCIÓN',
  p_tab_text => 'Inscripción',
  p_tab_step => 4,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'Reportes',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_concursos
wwv_flow_api.create_tab (
  p_id=> 4920303144693307 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Reportes',
  p_tab_sequence=> 30,
  p_tab_name=> 'T_CONCURSOS',
  p_tab_text => 'Concursos',
  p_tab_step => 5,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'Reportes',
  p_tab_comment  => '');
...
--application/shared_components/navigation/tabs/standard/t_ficha_pais
wwv_flow_api.create_tab (
  p_id=> 4808831367406424 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Reportes',
  p_tab_sequence=> 60,
  p_tab_name=> 'T_FICHA PAIS',
  p_tab_text => 'Ficha Pais',
  p_tab_step => 2,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'Reportes',
  p_tab_comment  => '');
...
wwv_flow_api.create_page_plug (
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Principales exportadores',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 4820630436273918 + wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 4820726573273925 + wwv_flow_api.g_id_offset,
  p_region_id=> 4816317576406444 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
