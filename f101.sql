...
--   Application:     101
--   Name:            WINES
--   Date and Time:   11:29 Tuesday December 18, 2018
...
wwv_flow_api.create_flow(
  ...
  p_checksum_salt_last_reset => '20181218112907',
  ...
  p_last_upd_yyyymmddhh24miss=> '20181218112907',
...
--application/shared_components/navigation/tabs/standard/t_ficha_concurso
wwv_flow_api.create_tab (
  p_id=> 5016407183305238 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Reportes',
  p_tab_sequence=> 90,
  p_tab_name=> 'T_FICHA CONCURSO',
  p_tab_text => 'Ficha Concurso',
  p_tab_step => 52,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'Reportes',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_reporteclasificaciónvinos
wwv_flow_api.create_tab (
  p_id=> 5056824502713222 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Reportes',
  p_tab_sequence=> 100,
  p_tab_name=> 'T_REPORTECLASIFICACIÓNVINOS',
  p_tab_text => 'Reporte Clasificación Vinos',
  p_tab_step => 21,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'Reportes',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/t_inscripciónaprendiz
wwv_flow_api.create_tab (
  p_id=> 5059219847651617 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Reportes',
  p_tab_sequence=> 110,
  p_tab_name=> 'T_INSCRIPCIÓNAPRENDIZ',
  p_tab_text => 'Inscripción Aprendiz',
  p_tab_step => 22,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'Reportes',
  p_tab_comment  => '');
...
'No help is available for this page.'
 ,p_last_updated_by => 'WINE_USER'
 ,p_last_upd_yyyymmddhh24miss => '20181218060912'
  );
null;
...
wwv_flow_api.create_page_plug (
  ...
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Producción, Exportación y Consumo Bodega (Hectolitros)',
  p_region_name=>'',
  p_plug_template=> 4887410716405498+ wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5015905564298835 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
  p_name=>'P1_SUB2',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page (
 ...
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'WINE_USER'
 ,p_last_upd_yyyymmddhh24miss => '20181217235606'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5012901998165399 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Posición en ranking mundial por superficie',
  p_region_name=>'',
  p_parent_plug_id=>4809030879406425 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5014227241219953 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Ranking mundial por producción',
  p_region_name=>'',
  p_parent_plug_id=>4809030879406425 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'select to_char(t.valor,''999,999,999.99'') || '' Millones de Hectáreas'' from '||chr(10)||
...
begin
wwv_flow_api.create_page_item(
  p_id=>5013216543169602 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_RANKINGSUP',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 130,
  p_item_plug_id => 5012901998165399+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Rankingsup',
  p_source=>'select ''#'' || to_char(posicion_ranking_superficie(:P2_SELECCIONARPAIS, :P2_ANIO)) from dual',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5014608325223995 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_RANKINGPROD',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 140,
  p_item_plug_id => 5014227241219953+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Rankingprod',
  p_source=>'select ''#'' || to_char(posicion_ranking_produccion(:P2_SELECCIONARPAIS, :P2_ANIO)) from dual;',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
wwv_flow_api.create_page (
 ...
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'WINE_USER'
 ,p_last_upd_yyyymmddhh24miss => '20181218004108'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5049507697453863 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Ventana de consumo',
  p_region_name=>'',
  p_parent_plug_id=>4939716223421460 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Año de consulta de presentaciones',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_NUMBER_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5049203410443207 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_CLASIF',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 140,
  p_item_plug_id => 4972112794823862+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Cla',
  p_source=>'select obtener_clasificacion_vino(:P6_SELECCIONARVINO) from dual',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5049921642514680 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_VENT',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 150,
  p_item_plug_id => 5049507697453863+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Vent',
  p_source=>'select ''Consumible hasta '' || to_char(formula_ventana_consumo(:P6_SELECCIONARVINO, :P6_TEST)) from dual;',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5053809847750397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 6,
  p_name=>'P6_TEST',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Añada',
  p_source=>'select distinct to_char(co.anio) name, co.anio value'||chr(10)||
'from Cosecha co, marcavino_b_do mvbdo, b_do bdo'||chr(10)||
'where mvbdo.fk_marcavino = :P6_SELECCIONARVINO'||chr(10)||
'and mvbdo.fk_b_do = bdo.id'||chr(10)||
'and mvbdo.fk_bodega = bdo.fk_bodega'||chr(10)||
'and mvbdo.fk_denominaciondeorigen = bdo.fk_do_id'||chr(10)||
'and mvbdo.fk_do_region = bdo.fk_do_region'||chr(10)||
'and mvbdo.fk_do_variedadvid = bdo.fk_do_variedadvid'||chr(10)||
'and co.fk_bdo_bodega = bdo.fk_bodega'||chr(10)||
'and co.fk_bdo_do_id = bdo.fk_do_id'||chr(10)||
'and co.fk_bdo_do_region = bdo.fk_do_region'||chr(10)||
'and co.fk_bdo_do_variedadvid = bdo.fk_do_variedadvid'||chr(10)||
'order by anio desc',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select distinct to_char(co.anio) name, co.anio value'||chr(10)||
'from Cosecha co, marcavino_b_do mvbdo, b_do bdo'||chr(10)||
'where mvbdo.fk_marcavino = :P6_SELECCIONARVINO'||chr(10)||
'and mvbdo.fk_b_do = bdo.id'||chr(10)||
'and mvbdo.fk_bodega = bdo.fk_bodega'||chr(10)||
...
wwv_flow_api.create_page (
 ...
 ,p_cache_by_user_yn => 'N'
 ,p_last_updated_by => 'WINE_USER'
 ,p_last_upd_yyyymmddhh24miss => '20181218060333'
  );
null;
...
prompt  ...PAGE 21: Clasificacion Vinos
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 21
 ,p_tab_set => 'Reportes'
 ,p_name => 'Clasificacion Vinos'
 ,p_step_title => 'Clasificacion Vinos'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'NO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'ANGEL'
 ,p_last_upd_yyyymmddhh24miss => '20181218002913'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select M.nombre "Marca Vino" , C.nombre "Clasificacion" from MarcaVino M, ClasificacionVinos C where '||chr(10)||
'M.fk_clasificacionvinos = C.id '||chr(10)||
'order by C.porcentajes.desde;';

wwv_flow_api.create_report_region (
  p_id=> 4846007975026177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 21,
  p_name=> 'Resultados',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 4847223690040256 + wwv_flow_api.g_id_offset,
  p_region_id=> 4846007975026177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'Marca Vino',
  p_column_display_sequence=> 1,
  p_column_heading=> 'Marca Vino',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'CENTER',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 4847332340040256 + wwv_flow_api.g_id_offset,
  p_region_id=> 4846007975026177 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
prompt  ...PAGE 22: Formulario Inscripción Catador
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 22
 ,p_tab_set => 'Reportes'
 ,p_name => 'Formulario Inscripción Catador'
 ,p_step_title => 'Formulario Inscripción Catador'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'NO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'ANGEL'
 ,p_last_upd_yyyymmddhh24miss => '20181218111537'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4848820700104622 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
  p_plug_name=> 'Ficha Inscripción ',
  p_region_name=>'',
  p_plug_template=> 4888504559405499+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4849608935104650 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
  p_plug_name=> 'Apellido',
  p_region_name=>'',
  p_parent_plug_id=>4848820700104622 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 50,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4850800700104676 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
  p_plug_name=> 'Género',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4851220878104679 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
  p_plug_name=> 'Fecha de nacimiento ',
  p_region_name=>'',
  p_parent_plug_id=>4848820700104622 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 110,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4851610590104681 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 4852823251104686 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 22,
  p_plug_name=> 'Nombre',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4849000168104638 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_CONCURSO',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  p_item_plug_id => 4848820700104622+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Seleccionar Concurso',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select C.nombre || '' ('' || to_char(E.id) || '')'' as nombre, E.id'||chr(10)||
'from Concurso C, Edicion E where C.deCatadores = ''S'' and E.fk_concurso = C.id',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> 4000,
...
begin
wwv_flow_api.create_page_item(
  p_id=>4849410022104649 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_GO',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4849825591104651 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_APELLIDO',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 100,
  p_item_plug_id => 4849608935104650+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default=> 'No hay un catador seleccionado',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Dos',
  p_source=>'select C.apellido from CatadorAprendiz C, Edicion E, Inscripcion I where I.fk_edicion = :P22_CONCURSO and I.fk_catadoraprendiz = :P22_PASAPORTE and C.pasaporte = I.fk_catadoraprendiz and E.id = :P22_CONCURSO',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4851015809104678 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_GENERO',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
  p_item_plug_id => 4850800700104676+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default=> 'No hay un catador seleccionado',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Vvid',
  p_source=>'select C.genero from CatadorAprendiz C, Edicion E, Inscripcion I where I.fk_edicion = :P22_CONCURSO and I.fk_catadoraprendiz = :P22_PASAPORTE and C.pasaporte = I.fk_catadoraprendiz and E.id = :P22_CONCURSO',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4851423029104680 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_FECHA',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 4851220878104679+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default=> 'No hay un catador seleccionado',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'select TO_CHAR(C.fechaDeNacimiento) from CatadorAprendiz C, Edicion E, Inscripcion I where I.fk_edicion = :P22_CONCURSO and I.fk_catadoraprendiz = :P22_PASAPORTE and C.pasaporte = I.fk_catadoraprendiz and E.id = :P22_CONCURSO',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4851813571104681 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_PROD_ANUAL',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 40,
  p_item_plug_id => 4851610590104681+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default=> 'No hay un país seleccionada',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Desc Cata',
  p_source=>'select C.lugarNacimiento.ciudad || '', '' || C.lugarNacimiento.pais from CatadorAprendiz C, Edicion E, Inscripcion I where I.fk_edicion = :P22_CONCURSO and I.fk_catadoraprendiz = :P22_PASAPORTE and C.pasaporte = I.fk_catadoraprendiz and E.id = :P22_CONCURSO',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4853008006104686 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_NOMBRE',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 50,
  p_item_plug_id => 4852823251104686+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_item_default=> 'No hay un catador seleccionado',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Bodega',
  p_source=>'select C.nombre from CatadorAprendiz C, Edicion E, Inscripcion I where I.fk_edicion = :P22_CONCURSO and I.fk_catadoraprendiz = :P22_PASAPORTE and C.pasaporte = I.fk_catadoraprendiz and E.id = :P22_CONCURSO',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>4855604311241873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 22,
  p_name=>'P22_PASAPORTE',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
wwv_flow_api.create_page (
 ...
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'WINE_USER'
 ,p_last_upd_yyyymmddhh24miss => '20181218082542'
  );
null;
...
begin
wwv_flow_api.create_page_item(
  p_id=>5058205903540586 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 30,
  p_name=>'P30_PRODUCCIONANIO',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 70,
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Producción en el año',
  p_source=>'select to_char(litros_a_hectolitros(produccion_pais_en(:P30_PAIS, :P30_ANIO))) || '' hectolitros'' from dual',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
wwv_flow_api.create_page (
 ...
 ,p_id => 52
 ,p_tab_set => 'Reportes'
 ,p_name => 'Ficha Concurso'
 ,p_alias => 'FICHA_CONCURSO'
 ,p_step_title => 'Ficha Concurso'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'NO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'WINE_USER'
 ,p_last_upd_yyyymmddhh24miss => '20181218081700'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5017009635318968 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Input',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5028327493513342 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Ficha concurso',
  p_region_name=>'',
  p_plug_template=> 4888420064405499+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 80,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5016619547312332 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Nombre',
  p_region_name=>'',
  p_parent_plug_id=>5028327493513342 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 20,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5026000650467717 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Tipo de concurso',
  p_region_name=>'',
  p_parent_plug_id=>5028327493513342 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 30,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select elemento, clasificacion, rangoinferior, rangosuperior '||chr(10)||
'from the (select escalas from concurso where id = :FC_CONCURSO)'||chr(10)||
'order by elemento';

wwv_flow_api.create_report_region (
  p_id=> 5026820783501981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Escalas',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5027130738501984 + wwv_flow_api.g_id_offset,
  p_region_id=> 5026820783501981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'ELEMENTO',
  p_column_display_sequence=> 1,
  p_column_heading=> 'ELEMENTO',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5027220850501984 + wwv_flow_api.g_id_offset,
  p_region_id=> 5026820783501981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5027313793501984 + wwv_flow_api.g_id_offset,
  p_region_id=> 5026820783501981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
  p_column_alias=> 'RANGOINFERIOR',
  p_column_display_sequence=> 3,
  p_column_heading=> 'RANGOINFERIOR',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5027413580501984 + wwv_flow_api.g_id_offset,
  p_region_id=> 5026820783501981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
  p_column_alias=> 'RANGOSUPERIOR',
  p_column_display_sequence=> 4,
  p_column_heading=> 'RANGOSUPERIOR',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
wwv_flow_api.create_report_region (
  p_id=> 5027512602509078 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Premios',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5027815426509079 + wwv_flow_api.g_id_offset,
  p_region_id=> 5027512602509078 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5027904901509079 + wwv_flow_api.g_id_offset,
  p_region_id=> 5027512602509078 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5028032374509079 + wwv_flow_api.g_id_offset,
  p_region_id=> 5027512602509078 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5028110089509079 + wwv_flow_api.g_id_offset,
  p_region_id=> 5027512602509078 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5028210702509079 + wwv_flow_api.g_id_offset,
  p_region_id=> 5027512602509078 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
  p_column_alias=> 'PREMIOMONEDA',
  p_column_display_sequence=> 5,
  p_column_heading=> 'PREMIOMONEDA',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select o.nombre || '' '' || o.descripcion Nombre'||chr(10)||
'from organizador o, organizador_concurso oc'||chr(10)||
'where oc.fk_concurso = :FC_CONCURSO and oc.fk_organizador = o.id';

wwv_flow_api.create_report_region (
  p_id=> 5047328587317952 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Organizadores',
  p_region_name=>'',
  p_parent_plug_id=>5028327493513342 + wwv_flow_api.g_id_offset,
  p_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5048202399319894 + wwv_flow_api.g_id_offset,
  p_region_id=> 5047328587317952 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5029111825527726 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'General Edición',
  p_region_name=>'',
  p_plug_template=> 4888420064405499+ wwv_flow_api.g_id_offset,
...
'    IF formatear_msj_tipo_conc(:FC_CONCURSO) = ''De vinos'' THEN'||chr(10)||
'        RETURN TRUE;'||chr(10)||
'    ELSE'||chr(10)||
'        RETURN FALSE;'||chr(10)||
'    END IF;'||chr(10)||
'END;',
  p_plug_display_when_cond2=>'De Catadores',
  p_pagination_display_position=>'BOTTOM_RIGHT',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
  p_plug_comment=> '');
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5035305470942269 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Fechas',
  p_region_name=>'',
  p_parent_plug_id=>5029111825527726 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 110,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5036910365972009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Dirección envío muestras',
  p_region_name=>'',
  p_parent_plug_id=>5029111825527726 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5038702147026494 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Datos de contacto',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5039607089084696 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Dirección de contacto',
  p_region_name=>'',
  p_parent_plug_id=>5038702147026494 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 180,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5041611132227801 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Datos Bancarios',
  p_region_name=>'',
  p_parent_plug_id=>5029111825527726 + wwv_flow_api.g_id_offset,
  p_plug_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5033113847774371 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Ficha Edición de Catadores',
  p_region_name=>'',
  p_plug_template=> 4888420064405499+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 140,
  p_plug_display_column=> 1,
  ...
  p_plug_display_when_condition => 'BEGIN'||chr(10)||
'if formatear_msj_tipo_conc(:FC_CONCURSO) not like ''De vinos'' then'||chr(10)||
'return true;'||chr(10)||
'else'||chr(10)||
'return false;'||chr(10)||
'end if;'||chr(10)||
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select ca.nombre || '' '' || ca.apellido Nombre'||chr(10)||
'from CatadorExperto ca, Juez j'||chr(10)||
'where j.fk_edicion =:FC_EDICION and ca.id = j.fk_catadorexperto';

wwv_flow_api.create_report_region (
  p_id=> 5033300336774372 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Jueces',
  p_region_name=>'',
  p_parent_plug_id=>5033113847774371 + wwv_flow_api.g_id_offset,
  p_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
  p_display_sequence=> 120,
  p_display_column=> 1,
  p_display_point=> 'AFTER_SHOW_ITEMS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5033524616774373 + wwv_flow_api.g_id_offset,
  p_region_id=> 5033300336774372 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select pais,nrodemuestras, valor'||chr(10)||
'from the (select costos from Edicion where id = :FC_EDICION)'||chr(10)||
'order by pais, nrodemuestras';

wwv_flow_api.create_report_region (
  p_id=> 5033603943774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Costos inscripción',
  p_region_name=>'',
  p_parent_plug_id=>5033113847774371 + wwv_flow_api.g_id_offset,
  p_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5033824530774373 + wwv_flow_api.g_id_offset,
  p_region_id=> 5033603943774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'PAIS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5033927231774373 + wwv_flow_api.g_id_offset,
  p_region_id=> 5033603943774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  p_column_alias=> 'NRODEMUESTRAS',
  p_column_display_sequence=> 2,
  p_column_heading=> 'NRODEMUESTRAS',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5034023415774373 + wwv_flow_api.g_id_offset,
  p_region_id=> 5033603943774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select  mv.nombre, mc.anada, obtener_clasificacion_vino(mv.id) tipo, mc.sumatoriaexperto'||chr(10)||
'from MuestraCatador mc, Juez j, MarcaVino mv'||chr(10)||
'where j.fk_edicion = :FC_EDICION'||chr(10)||
'and mc.fk_catadorexperto = j.fk_catadorexperto'||chr(10)||
'and mc.fk_edicion = j.fk_edicion'||chr(10)||
'and mv.id = mc.fk_marcavino_id';

wwv_flow_api.create_report_region (
  p_id=> 5034126252774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Muestras en competencia',
  p_region_name=>'',
  p_parent_plug_id=>5033113847774371 + wwv_flow_api.g_id_offset,
  p_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5034303285774375 + wwv_flow_api.g_id_offset,
  p_region_id=> 5034126252774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5034400916774375 + wwv_flow_api.g_id_offset,
  p_region_id=> 5034126252774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  p_column_alias=> 'ANADA',
  p_column_display_sequence=> 2,
  p_column_heading=> 'ANADA',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5034526104774375 + wwv_flow_api.g_id_offset,
  p_region_id=> 5034126252774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5035103345913293 + wwv_flow_api.g_id_offset,
  p_region_id=> 5034126252774373 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
  p_column_alias=> 'SUMATORIAEXPERTO',
  p_column_display_sequence=> 4,
  p_column_heading=> 'Sumatoriaexperto',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'CENTER',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5044406723283303 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_plug_name=> 'Ficha Edición de Vinos',
  p_region_name=>'',
  p_plug_template=> 4888420064405499+ wwv_flow_api.g_id_offset,
  ...
  p_plug_display_condition_type => 'FUNCTION_BODY',
  p_plug_display_when_condition => 'BEGIN'||chr(10)||
'if formatear_msj_tipo_conc(:FC_CONCURSO) like ''De vinos'' then'||chr(10)||
'return true;'||chr(10)||
'else'||chr(10)||
'return false;'||chr(10)||
'end if;'||chr(10)||
...
wwv_flow_api.create_report_region (
  p_id=> 5044627848289357 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Jueces',
  p_region_name=>'',
  p_parent_plug_id=>5044406723283303 + wwv_flow_api.g_id_offset,
  p_template=> 4886632719405498+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5044803797289359 + wwv_flow_api.g_id_offset,
  p_region_id=> 5044627848289357 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
wwv_flow_api.create_report_region (
  p_id=> 5044900621290985 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Costos inscripción',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5045100347290985 + wwv_flow_api.g_id_offset,
  p_region_id=> 5044900621290985 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'PAIS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5045219346290985 + wwv_flow_api.g_id_offset,
  p_region_id=> 5044900621290985 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5045321206290985 + wwv_flow_api.g_id_offset,
  p_region_id=> 5044900621290985 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select distinct mv.nombre, mc.anada, obtener_clasificacion_vino(mv.id) tipo, bo.nombre Bodega'||chr(10)||
'from muestracompite mc, Inscripcion ic, MarcaVino mv, Bodega bo, MarcaVino_B_DO mvbdo'||chr(10)||
'where ic.fk_edicion = :FC_EDICION'||chr(10)||
'and mc.fk_inscripcion = ic.id'||chr(10)||
'and mv.id = mc.fk_marcavino'||chr(10)||
'and mv.fk_clasificacionvinos = mc.fk_clasificacionvinos'||chr(10)||
'and mvbdo.fk_marcavino = mv.id'||chr(10)||
'and mvbdo.fk_clasificacionvinos = mv.fk_c';

s:=s||'lasificacionvinos'||chr(10)||
'and mvbdo.fk_bodega = bo.id';

wwv_flow_api.create_report_region (
  p_id=> 5045404430292035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Muestras en competencia',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5045630743292036 + wwv_flow_api.g_id_offset,
  p_region_id=> 5045404430292035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5045707644292036 + wwv_flow_api.g_id_offset,
  p_region_id=> 5045404430292035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5045810701292036 + wwv_flow_api.g_id_offset,
  p_region_id=> 5045404430292035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5045901144292036 + wwv_flow_api.g_id_offset,
  p_region_id=> 5045404430292035 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select bo.nombre Bodega, mv.nombre Vino, a.nombre Premio'||chr(10)||
'from Bodega bo, MarcaVino mv, MuestraCompite mc, Inscripcion i, MarcaVino_B_DO mvbdo CROSS JOIN TABLE(mc.premio) a'||chr(10)||
'where i.fk_edicion = :FC_EDICION'||chr(10)||
'and mc.fk_inscripcion = i.id'||chr(10)||
'and mv.id = mc.fk_marcavino'||chr(10)||
'and mvbdo.fk_marcavino = mv.id'||chr(10)||
'and bo.id = mvbdo.fk_bodega';

wwv_flow_api.create_report_region (
  p_id=> 5054723372905693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Ganadores concurso de vinos',
  p_region_name=>'',
  p_template=> 4888420064405499+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5055001544905693 + wwv_flow_api.g_id_offset,
  p_region_id=> 5054723372905693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'BODEGA',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5055108567905693 + wwv_flow_api.g_id_offset,
  p_region_id=> 5054723372905693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5055218727905693 + wwv_flow_api.g_id_offset,
  p_region_id=> 5054723372905693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select ca.nombre || '' '' || ca.apellido Nombre, i.premioCatador Premio, pr.posicion'||chr(10)||
'from CatadorAprendiz ca, Inscripcion i, Edicion e, Concurso c cross join table (c.premios) pr'||chr(10)||
'where e.id = :FC_EDICION'||chr(10)||
'and i.fk_edicion = e.id'||chr(10)||
'and e.fk_concurso = c.id'||chr(10)||
'and ca.pasaporte = i.fk_catadoraprendiz'||chr(10)||
'and i.premioCatador is not null'||chr(10)||
'and pr.nombre = i.premioCatador'||chr(10)||
'order by pr.posicion asc';

wwv_flow_api.create_report_region (
  p_id=> 5057218408496833 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 52,
  p_name=> 'Ganadores concurso de catadores',
  p_region_name=>'',
  p_template=> 4888420064405499+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5057824641498610 + wwv_flow_api.g_id_offset,
  p_region_id=> 5057218408496833 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5057614814496835 + wwv_flow_api.g_id_offset,
  p_region_id=> 5057218408496833 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5057912801498610 + wwv_flow_api.g_id_offset,
  p_region_id=> 5057218408496833 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_branch(
  p_id=>5030411508556426 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_branch_action=> 'f?p=&FLOW_ID.:52:&SESSION.',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_sequence=> 99,
  p_save_state_before_branch_yn=>'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5016930975315663 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_NOMBRE',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5016619547312332+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Nombre',
  p_source=>'select nombre from concurso where id = :FC_CONCURSO',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5017527990324280 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_CONCURSO',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  p_item_plug_id => 5017009635318968+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Concurso',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select nombre, id from Concurso',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> 4000,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5018430554410174 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_EDICION',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select to_char(fechainicio) || '' al '' || to_char(fechafin) nom, id'||chr(10)||
'from edicion where fk_concurso = :FC_CONCURSO',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> 4000,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5026311994489914 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_TIPO',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 40,
  p_item_plug_id => 5026000650467717+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Tipo',
  p_source=>'select formatear_msj_tipo_conc(:FC_CONCURSO) from dual',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5030725032559940 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_SUB',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5035600406950294 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_LIMINSC',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
  p_item_plug_id => 5035305470942269+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Limite envío inscripción ',
  p_source=>'select fechaLimiteEnvioDeInscripcion from Edicion where id=:FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5035922570956626 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_RECEVINOS',
  p_data_type=> 'VARCHAR',
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Limite recepción vinos',
  p_source=>'select fechaLimiteRecepcionVinos from Edicion where id=:FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5036100883959846 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_INICIO',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Inicio',
  p_source=>'select fechaInicio from Edicion where id=:FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5036309541962397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_FIN',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Inicio',
  p_source=>'select fechaFin from Edicion where id=:FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5037207033980595 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_ENV_EST',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 100,
  p_item_plug_id => 5036910365972009+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Estado',
  p_source=>'select e.direccionEnvioMuestras.estado'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5037421231984649 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_ENV_POSTAL',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 110,
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Código postal',
  p_source=>'select e.direccionEnvioMuestras.codigoPostal'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5037808680999916 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_ENV_L1',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Linea 1',
  p_source=>'select e.direccionEnvioMuestras.lineaDireccion1'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5038014913001744 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_ENV_L2',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Linea 1',
  p_source=>'select e.direccionEnvioMuestras.lineaDireccion2'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5039018470059590 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_FAX',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 140,
  p_item_plug_id => 5038702147026494+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Fax',
  p_source=>'select e.datosDeContacto.fax'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5039208212066062 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_EMAIL',
  p_data_type=> 'VARCHAR',
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Email inscripción',
  p_source=>'select e.emailEnvioInscripcion'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5039502802073944 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_WEB',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Dirección web',
  p_source=>'select e.datosDeContacto.direccionWeb'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5039916439087331 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_DC_EST',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5039607089084696+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Estado',
  p_source=>'select e.datosDeContacto.dir.estado'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5040228906090954 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_DC_POSTAL',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Código postal',
  p_source=>'select e.datosDeContacto.dir.codigoPostal'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5040517609097159 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_DC_L1',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Linea 1 ',
  p_source=>'select e.datosDeContacto.dir.lineaDireccion1'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5040725228099307 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_DC_L2',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Linea 2',
  p_source=>'select e.datosDeContacto.dir.lineaDireccion2'||chr(10)||
'from Edicion e where id = :FC_EDICION',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5041011768123865 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_TLFN',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Teléfonos',
  p_source=>'select obtener_telefonos(e.datosDeContacto.telefonos)'||chr(10)||
'from Edicion e where id = :FC_EDICION',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5042031910233760 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 52,
  p_name=>'FC_BANCC',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 210,
  p_item_plug_id => 5041611132227801+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'select obtener_datos_bancarios(:FC_EDICION)'||chr(10)||
'from dual',
  p_source_type=> 'QUERY',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
